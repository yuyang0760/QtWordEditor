    ...
    , d(new Private)
{
    ...
    d->alignmentCombo->addItem(tr("Left"), static_cast<int>(ParagraphStyle::Alignment::Left));
    d->alignmentCombo->addItem(tr("Center"), static_cast<int>(ParagraphStyle::Alignment::Center));
    d->alignmentCombo->addItem(tr("Right"), static_cast<int>(ParagraphStyle::Alignment::Right));
    d->alignmentCombo->addItem(tr("Justify"), static_cast<int>(ParagraphStyle::Alignment::Justify));
...
ParagraphStyle ParagraphDialog::selectedStyle() const
{
    ...
    style.setAlignment(static_cast<ParagraphStyle::Alignment>(
